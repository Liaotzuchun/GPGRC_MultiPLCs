    ...
    public Dictionary<string, object> ToBottomDictionary() => new()
                                                        {
                                                            ...
                                                            { nameof(BottomDwellTime_1),             (float)DwellTime_1 },
                                                            { nameof(BottomDwellTime_2),             (float)DwellTime_2 },
                                                            { nameof(BottomDwellTime_3),             (float)DwellTime_3 },
                                                            { nameof(BottomDwellTime_4),             (float)DwellTime_4 },
                                                            { nameof(BottomDwellTime_5),             (float)DwellTime_5 },
                                                            { nameof(BottomDwellTime_6),             (float)DwellTime_6 },
                                                            { nameof(BottomDwellAlarm_1),            (float)DwellAlarm_1 },
                                                            { nameof(BottomDwellAlarm_2),            (float)DwellAlarm_2 },
                                                            { nameof(BottomDwellAlarm_3),            (float)DwellAlarm_3 },
                                                            { nameof(BottomDwellAlarm_4),            (float)DwellAlarm_4 },
                                                            { nameof(BottomDwellAlarm_5),            (float)DwellAlarm_5 },
                                                            { nameof(BottomDwellAlarm_6),            (float)DwellAlarm_6 },
                                                            { nameof(BottomCoolingTime),             CoolingTime },
                                                            { nameof(BottomCoolingTemperature),      CoolingTemperature },
                                                            { nameof(BottomRampTime_1),              (float)RampTime_1 },
                                                            { nameof(BottomRampTime_2),              (float)RampTime_2 },
                                                            { nameof(BottomRampTime_3),              (float)RampTime_3 },
                                                            { nameof(BottomRampTime_4),              (float)RampTime_4 },
                                                            { nameof(BottomRampTime_5),              (float)RampTime_5 },
                                                            { nameof(BottomRampTime_6),              (float)RampTime_6 },
                                                            { nameof(BottomRampAlarm_1),             (float)RampAlarm_1 },
                                                            { nameof(BottomRampAlarm_2),             (float)RampAlarm_2 },
                                                            { nameof(BottomRampAlarm_3),             (float)RampAlarm_3 },
                                                            { nameof(BottomRampAlarm_4),             (float)RampAlarm_4 },
                                                            { nameof(BottomRampAlarm_5),             (float)RampAlarm_5 },
                                                            { nameof(BottomRampAlarm_6),             (float)RampAlarm_6 },
