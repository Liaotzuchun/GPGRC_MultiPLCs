...
namespace GPGO_MultiPLCs.Models
{
    ...
    //    public TwoKeyDictionary<SignalNames, (BitType, int), bool> PCtoPLCBits;

    //    #region PC=>PLC

    //    public bool Start
    //    {
    //        get => Bit_Values[SignalNames.執行啟動];
    //        set => Bit_Values[SignalNames.執行啟動] = value;
    //    }

    //    public bool Stop
    //    {
    //        get => Bit_Values[SignalNames.執行停止];
    //        set => Bit_Values[SignalNames.執行停止] = value;
    //    }

    //    public bool Check
    //    {
    //        get => Bit_Values[SignalNames.PC_HeartBeat];
    //        set => Bit_Values[SignalNames.PC_HeartBeat] = value;
    //    }
    ...
    //        set
    //        {
    //            Recipe_Values[DataNames.降溫溫度] = (short)value;
    //            NotifyPropertyChanged();
    //        }
    //    }
    ...
    //    public bool AllowStart => Bit_Values[SignalNames.允許啟動];
    //    public bool AllowStop => Bit_Values[SignalNames.允許停止];
    ...
    //            new[]
    //                {
    //                    Recipe_Values[DataNames.RackID_01], Recipe_Values[DataNames.RackID_02], Recipe_Values[DataNames.RackID_03], Recipe_Values[DataNames.RackID_04],
    //                    Recipe_Values[DataNames.RackID_05], Recipe_Values[DataNames.RackID_06], Recipe_Values[DataNames.RackID_07], Recipe_Values[DataNames.RackID_08],
    //                    Recipe_Values[DataNames.RackID_09], Recipe_Values[DataNames.RackID_10], Recipe_Values[DataNames.RackID_11], Recipe_Values[DataNames.RackID_12],
    //                    Recipe_Values[DataNames.RackID_13], Recipe_Values[DataNames.RackID_14], Recipe_Values[DataNames.RackID_15], Recipe_Values[DataNames.RackID_16],
    //                    Recipe_Values[DataNames.RackID_17], Recipe_Values[DataNames.RackID_18], Recipe_Values[DataNames.RackID_19], Recipe_Values[DataNames.RackID_20],
    //                }.ASCIIfromShorts()
    //                 .Trim();
    //        set
    //        {
    ...
    //            Recipe_Values[DataNames.RackID_01] = vals[0];
    //            Recipe_Values[DataNames.RackID_02] = vals[1];
    //            Recipe_Values[DataNames.RackID_03] = vals[2];
    //            Recipe_Values[DataNames.RackID_04] = vals[3];
    //            Recipe_Values[DataNames.RackID_05] = vals[4];
    //            Recipe_Values[DataNames.RackID_06] = vals[5];
    //            Recipe_Values[DataNames.RackID_07] = vals[6];
    //            Recipe_Values[DataNames.RackID_08] = vals[7];
    //            Recipe_Values[DataNames.RackID_09] = vals[8];
    //            Recipe_Values[DataNames.RackID_10] = vals[9];
    //            Recipe_Values[DataNames.RackID_11] = vals[10];
    //            Recipe_Values[DataNames.RackID_12] = vals[11];
    //            Recipe_Values[DataNames.RackID_13] = vals[12];
    //            Recipe_Values[DataNames.RackID_14] = vals[13];
    //            Recipe_Values[DataNames.RackID_15] = vals[14];
    //            Recipe_Values[DataNames.RackID_16] = vals[15];
    //            Recipe_Values[DataNames.RackID_17] = vals[16];
    //            Recipe_Values[DataNames.RackID_18] = vals[17];
    //            Recipe_Values[DataNames.RackID_19] = vals[18];
    //            Recipe_Values[DataNames.RackID_20] = vals[19];
