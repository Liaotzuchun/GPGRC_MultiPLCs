...
namespace GPGO_MultiPLCs.Views
{
    ...
    public class TimespanAgo : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return value is DateTime time ? $"{(DateTime.Now < time ? "- " : "")}{DateTime.Now - time:d\'d \'hh\':\'mm\':\'ss}" : "";
        }
    ...
    public class StrCheckVis : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return value != null && value.ToString() != "" ? Visibility.Visible : Visibility.Collapsed;
        }
