...
namespace GPGO_MultiPLCs.Helpers
{
    ...
    public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, IList
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether the buffer is "split" (meaning the beginning of the view is at a later index
        ///     in <see cref="_buffer" /> than the end).
        /// </summary>
        private bool IsSplit => _offset > Capacity - Count;

        /// <summary>
        ///     Gets or sets the capacity for this deque. This value must always be greater than zero, and this property
        ///     cannot be set to a value less than <see cref="Count" />.
        /// </summary>
        ...
        /// <summary>
        ///     Increments <see cref="_offset" /> by <paramref name="value" /> using modulo-<see cref="Capacity" />
        ///     arithmetic.
        /// </summary>
        ...
        /// <summary>
        ///     Decrements <see cref="_offset" /> by <paramref name="value" /> using modulo-<see cref="Capacity" />
        ///     arithmetic.
        /// </summary>
        /// <param name="value">
        ...
        /// <summary>
        ///     Inserts a single element to the back of the view. <see cref="IsFull" /> must be false when this method is
        ///     called.
        /// </summary>
        /// <param name="value">The element to insert.</param>
        ...
        /// <summary>
        ///     Inserts a single element to the front of the view. <see cref="IsFull" /> must be false when this method is
        ///     called.
        /// </summary>
        /// <param name="value">The element to insert.</param>
        ...
        /// <summary>
        ///     Removes and returns the last element in the view. <see cref="IsEmpty" /> must be false when this method is
        ///     called.
        /// </summary>
        /// <returns>The former last element.</returns>
        ...
        /// <summary>
        ///     Removes and returns the first element in the view. <see cref="IsEmpty" /> must be false when this method is
        ///     called.
        /// </summary>
        /// <returns>The former first element.</returns>
        ...
        /// <summary>
        ///     Checks the <paramref name="index" /> argument to see if it refers to a valid insertion point in a source of a
        ///     given length.
        /// </summary>
        ...
        /// <summary>
        ///     Checks the <paramref name="index" /> argument to see if it refers to an existing element in a source of a
        ///     given length.
        /// </summary>
        /// <param name="sourceLength">The length of the source. This parameter is not checked for validity.</param>
        /// <param name="index">The index into the source.</param>
        ...
        /// <summary>
        ///     Checks the <paramref name="offset" /> and <paramref name="count" /> arguments for validity when applied to a
        ///     source of a given length. Allows 0-element ranges, including a 0-element range at the end of the source.
        /// </summary>
        /// <param name="sourceLength">The length of the source. This parameter is not checked for validity.</param>
