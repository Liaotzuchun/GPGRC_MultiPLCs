...
public static class Extensions
{
    ...
    public static List<User> UsersFromCSVFILE(string path) => FastCSV.ReadFile<User>(path,
                                                                                     ',',
                                                                                     (o, c) =>
                                                                                     {
                                                                                         o.Name = c[0];
    ...
    public static void RecipesToCSVFILE(this IEnumerable<PLC_Recipe> users, string path) => FastCSV.WriteFile(path,
                                                                                                              new[]
                                                                                                              {
                                                                                                                  "配方名稱",
                                                                                                                  "氮氣模式",
    ...
    public static List<PLC_Recipe> RecipesFromCSVFILE(string path) => FastCSV.ReadFile<PLC_Recipe>(path,
                                                                                                   ',',
                                                                                                   (o, c) =>
                                                                                                   {
                                                                                                       o.RecipeName = c[0];
